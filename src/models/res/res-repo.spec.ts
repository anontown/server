...
function run(repoGene: () => IResRepo, isReset: boolean) {
  ...
  describe("findOne", () => {
    it("正常に探せるか", async () => {
      ...
      await repo.insert(resNormal.copy({ id: "res2" }));
  ...
  describe("findIn", () => {
    it("正常に探せるか", async () => {
      ...
      const res2 = resNormal.copy({ id: "res2", date: new Date(80) });
      const res3 = resNormal.copy({ id: "res3", date: new Date(30) });
      const res4 = resNormal.copy({ id: "res4", date: new Date(90) });
  ...
  describe("find", () => {
    it("正常に検索出来るか", async () => {
      ...
      const res1 = resNormal.copy({ id: "res1", date: new Date(50) });
      const res2 = resNormal.copy({ id: "res2", date: new Date(80), topic: "topic2" });
      const res3 = resNormal.copy({ id: "res3", date: new Date(30) });
      const res4 = resNormal.copy({ id: "res4", date: new Date(90) });
      const res5 = resNormal.copy({ id: "res5", date: new Date(20) });
      const res6 = resNormal.copy({ id: "res6", date: new Date(10) });
      const res7 = resNormal.copy({ id: "res7", date: new Date(60) });
      const res8 = resNormal.copy({ id: "res8", date: new Date(40) });
  ...
  describe("findHash", () => {
    it("正常に検索出来るか", async () => {
      ...
      const res2 = resNormal.copy({ id: "res2", date: new Date(80), hash: "hash1" });
      const res3 = resNormal.copy({ id: "res3", date: new Date(30) });
      const res4 = resNormal.copy({ id: "res4", date: new Date(90) });
      const res5 = resNormal.copy({ id: "res5", date: new Date(20) });
      const res6 = resNormal.copy({ id: "res6", date: new Date(10) });
  ...
  describe("update", () => {
    it("正常に更新出来るか", async () => {
      ...
      const res2 = resNormal.copy({ id: "res2" });
